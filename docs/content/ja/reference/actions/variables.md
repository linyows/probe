...
`status`が`0`になる条件はアクションごとに異なります。

#### HTTPアクション

HTTPではステータスコードで判定します。
...
詳細なリトライ設定については[アクションガイド](/ja/guide/concepts/actions#リトライ機能)を参照してください。
