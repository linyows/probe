...
func TestStep_getEchoOutput(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			echo:        "Hello World",
			context:     StepContext{},
			expected:    "       \x1b[90mHello World\x1b[0m\n",
			expectError: false,
		},
		{
			...
			echo:        "Line 1\nLine 2\nLine 3",
			context:     StepContext{},
			expected:    "       \x1b[90mLine 1\x1b[0m\n       \x1b[90mLine 2\x1b[0m\n       \x1b[90mLine 3\x1b[0m\n",
			expectError: false,
		},
		{
			...
			echo:        "Header\n  Indented\n    More indented\nBack to left",
			context:     StepContext{},
			expected:    "       \x1b[90mHeader\x1b[0m\n       \x1b[90m  Indented\x1b[0m\n       \x1b[90m    More indented\x1b[0m\n       \x1b[90mBack to left\x1b[0m\n",
			expectError: false,
		},
		{
		...
		},
		{
			...
			expected:    "       \x1b[90mStatus: OK\x1b[0m\n",
			expectError: false,
		},
		{
